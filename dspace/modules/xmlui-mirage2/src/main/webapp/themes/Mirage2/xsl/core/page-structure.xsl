...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
                                    ...
                                    <div class="horizontal-slider clearfix">
                                        <div class="col-xs-12 col-sm-12 col-md-9 main-content">
                                            ...
                                            <xsl:choose>
                                                ...
                                                <div id="bitstreamRestrictionNotice" class="alert alert-warning" role="alert">NOTE: This item is not available outside the Texas A&amp;M University network. Texas A&amp;M affiliated users who are off campus can access the item through <xsl:element name="a">
                                                  <xsl:attribute name="href">
                                                     <xsl:value-of select="concat('http://ezproxy.library.tamu.edu/login?url=',//dri:meta/dri:pageMeta/dri:metadata[@element='citation_abstract_html_url'])"/>
                                                  </xsl:attribute>
                                                  Ezproxy authentication
                                                </xsl:element> or by using <a href="http://it.tamu.edu/Connecting/Internet_Wireless/Virtual_Private_Network__VPN_.php" target="_blank">TAMU VPN</a>. Non-affiliated individuals should request a copy through their local library's interlibrary loan service.</div>
                                                </xsl:when>
                                                ...
                                                <div id="bitstreamRestrictionNotice" class="alert alert-warning" role="alert">NOTE: You are not authorized to access some or all of the files below. Alternatively you can attempt to access this item through <xsl:element name="a">
                                                  <xsl:attribute name="href">
                                                     <xsl:value-of select="concat('http://ezproxy.library.tamu.edu/login?url=',//dri:meta/dri:pageMeta/dri:metadata[@element='citation_abstract_html_url'])"/>
                                                  </xsl:attribute>
                                                  Ezproxy authentication
    ...
    <!-- TAMU CUSTOMIZATION: Display the loggen chooser page which asks the user to login via shibboleth or via an email/password pair -->
