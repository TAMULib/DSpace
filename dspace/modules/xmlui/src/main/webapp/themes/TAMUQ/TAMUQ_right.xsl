...
<xsl:stylesheet 
    ...
    <xsl:import href="TAMUQ_common.xsl"/>
        ...
        <div id="ds-body">
            ...
            <xsl:if test="count($front_page_searches) >= 1">
                <div id="front-page-image-wrapper">
                    <img src="{$theme-path}/images/small_esl.jpg"></img>
                </div>
            </xsl:if>
        ...
        <div id="ds-footer">
            ...
            <div id="ds-footer-internal-wrapper">
                <a id="ds-footer-logo-anchor" href="http://www.qatar.tamu.edu">                            
                    ...
                    <img id="ds-footer-logo" src="{$theme-path}/images/logo_footer-1.jpg"></img>
                </a>
                <p>
        ...
        <div id="headerWrapper">
            <div id="ds-header">
                <a id="ds-header-logo-anchor">
                    ...
                    <img id="ds-header-logo" src="{$theme-path}/images/logo-1.jpg"></img>
                </a>
...
<!-- 
    ...
    <!-- moved colon in following template
    ...
    <!-- Just a plain old table cell - note the apply-templates at the end ensure that fields get placed before (to the left of) other elements -->
    <xsl:template match="dri:cell" priority="1">
        <td>
            ...
            <xsl:apply-templates select="*[not(self::dri:field)]"/>
        </td>
    </xsl:template>
