...
public class Item extends DSpaceObject
{
     ...
     * @throws AuthorizeException
     */
    public void update(boolean versioning) throws SQLException, AuthorizeException
    {
        if(versioning) {
            if(!AuthorizeManager.authorizeVersioning(ourContext, this)) {
                throw new AuthorizeException(
                        "Authorization denied for versioning " + this.getID() + 
                        " by user " + ourContext.getCurrentUser().getID());
            }
        }
        else {
            // Check authorisation
