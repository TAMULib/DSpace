                            ...
                            <div class="image-gallery-tile-content">
                                ...
                                <div class="image-gallery-links">
                                    <a>
                                        ...
                                        <img src="{$theme-path}/PrimerosLibros/imgs/filmstrip_icon.png" alt="Detailed view of this page" title="Detailed view of this page" />
                                    </a>
                                    <!--
                                        <a target="_new">
                                        <xsl:attribute name="href">
                                        ...
                                        <img src="{$theme-path}/PrimerosLibros/imgs/image.jpg" alt="View detailed image" title="View detailed image" />
                                        </a>
                                    -->
                                    <span class="image-gallery-save-link"> 
                                        ...
                                        -->
                                        <img src="{$theme-path}/PrimerosLibros/imgs/save_icon.jpg" alt="Download image" title="Download image" />
                                    </span>
            	...
            	<img class="image-gallery-thumbnail">
                  ...
                  <xsl:choose>
                    <xsl:when test="$bitstream-count = '0'">
                      <xsl:value-of select="$theme-path"/><xsl:text>/PrimerosLibros/imgs/blank_book.png</xsl:text>
                    </xsl:when>
            ...
            <div class="image-gallery-date">
           	...
           	<div class="image-gallery-links">
           		<a target="_new">
           			...
           			<img src="{$theme-path}/PrimerosLibros/imgs/image.jpg" alt="View book in book reader" title="View book in book reader" />
           		</a>
              <!--
           		<a href="{ancestor::mets:METS/@OBJID}">
           			<img src="{$theme-path}/PrimerosLibros/imgs/detail_icon.jpg" alt="View item details and metadata" title="View item details and metadata" />
           		</a>-->
                ...
                <span class="image-gallery-save-link"> 
            		...
            		-->		<img src="{$theme-path}/PrimerosLibros/imgs/save_icon.jpg" alt="Download other sizes" title="Download other sizes" />
